...
export interface AgentCardResponse {
    ...
    signatures?: Corti.AgentCardResponseSignaturesItem[];
    /** Skills the agent exposes. */
    skills?: Corti.AgentCardResponseSkillsItem[];
    /** A2A protocol bindings. v2 advertises protocolVersion `1.0` only. */
    supportedInterfaces: Corti.AgentCardResponseSupportedInterfacesItem[];
}
