...
export class VersionsClient {
    ...
    private async __list(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `documents/sections/${core.url.encodePathParam(sectionID)}/versions/`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.documents.sections.versions.list.Response.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(
            ...
            "GET",
            "/documents/sections/{sectionID}/versions/",
        );
    }
    ...
    public create(
        sectionID: string,
        request: Corti.documents.sections.CreateSectionVersionRequest,
        requestOptions?: VersionsClient.RequestOptions,
    ): core.HttpResponsePromise<Corti.SectionVersion> {
    ...
    private async __create(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.documents.sections.CreateSectionVersionRequest.jsonOrThrow(request, {
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)).base,
                `documents/sections/${core.url.encodePathParam(sectionID)}/versions/${core.url.encodePathParam(versionID)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/documents/sections/{sectionID}/versions/{versionID}",
        );
    }
    ...
    private async __publish(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)).base,
                `documents/sections/${core.url.encodePathParam(sectionID)}/versions/${core.url.encodePathParam(versionID)}/publish`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/documents/sections/{sectionID}/versions/{versionID}/publish",
        );
    }
}
