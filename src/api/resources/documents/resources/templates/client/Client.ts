...
export class TemplatesClient {
    ...
    /**
     * @param {string} templateID
     * @param {Corti.documents.UpdateTemplateRequest} request
     * @param {TemplatesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Corti.BadRequestError}
     * @throws {@link Corti.NotFoundError}
    ...
    public update(
        templateID: string,
        request: Corti.documents.UpdateTemplateRequest = {},
        requestOptions?: TemplatesClient.RequestOptions,
    ): core.HttpResponsePromise<Corti.Template> {
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.documents.UpdateTemplateRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
