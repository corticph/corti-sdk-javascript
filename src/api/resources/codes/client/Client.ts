...
export class Codes {
     ...
     *
     * @example
     *     await client.codes.predictDeprecated({
     *         system: ["icd10cm", "cpt"],
     *         context: [{
     *                 type: "text",
    ...
    public predictDeprecated(
        ...
        return core.HttpResponsePromise.fromPromise(this.__predictDeprecated(request, requestOptions));
    }

    private async __predictDeprecated(
        request: Corti.CodesGeneralPredictRequest,
        requestOptions?: Codes.RequestOptions,
