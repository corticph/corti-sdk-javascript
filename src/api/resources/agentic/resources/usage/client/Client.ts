...
export class UsageClient {
     ...
     * @param {Corti.agentic.GetUsageRequest} request
     ...
     *
     * @example
     *     await client.agentic.usage.get("agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40", {
    ...
    public get(
        ...
        request: Corti.agentic.GetUsageRequest = {},
