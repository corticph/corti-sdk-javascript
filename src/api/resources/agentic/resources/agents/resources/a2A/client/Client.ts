...
export class A2AClient {
     ...
     * @param {Corti.agentic.agents.A2AjsonrpcRequest} request
     ...
     *
     * @example
     *     await client.agentic.agents.a2A.jsonRpc("agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40", {
     *         id: "1",
     *         method: "SendMessage",
     *         params: {
     *             "message": {
    ...
    public jsonRpc(
        ...
        request: Corti.agentic.agents.A2AjsonrpcRequest,
    ...
    private async __jsonRpc(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: {
                ...serializers.agentic.agents.A2AjsonrpcRequest.jsonOrThrow(request, {
     ...
     *
     * @example
     *     await client.agentic.agents.a2A.sendMessage("agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40", {
     *         message: {
     *             messageId: "msg.0192f4c8-5f8d-7e61-924d-6fb09b5ead73",
     *             role: "ROLE_USER",
     *             parts: [{
