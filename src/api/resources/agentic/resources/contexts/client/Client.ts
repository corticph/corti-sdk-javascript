...
export class ContextsClient {
    ...
    ): core.HttpResponsePromise<Corti.ContextsListResponse> {
    ...
    public getTrace(
        ...
        requestOptions?: ContextsClient.RequestOptions,
    ): core.HttpResponsePromise<Corti.ContextsTraceResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getTrace(contextId, request, requestOptions));
    }

    private async __getTrace(
        contextId: Corti.CommonContextIdValue,
        request: Corti.agentic.GetTraceContextsRequest = {},
        requestOptions?: ContextsClient.RequestOptions,
