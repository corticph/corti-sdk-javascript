...
export class ContextsClient {
     ...
     *
     * @param {Corti.agentic.AgenticContextsListRequest} request
     ...
     */
    public async list(
        request: Corti.agentic.AgenticContextsListRequest = {},
        requestOptions?: ContextsClient.RequestOptions,
    ): Promise<core.Page<Corti.AgenticContext, Corti.AgenticContextsListResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Corti.agentic.AgenticContextsListRequest,
            ): Promise<core.WithRawResponse<Corti.AgenticContextsListResponse>> => {
                ...
                if (_response.ok) {
                    return {
                        data: serializers.AgenticContextsListResponse.parseOrThrow(_response.body, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/agentic/contexts");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Corti.AgenticContext, Corti.AgenticContextsListResponse>({
     ...
     * @param {Corti.agentic.AgenticContextsGetRequest} request
     * @param {ContextsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Corti.UnauthorizedError}
    ...
    public get(
        ...
        request: Corti.agentic.AgenticContextsGetRequest = {},
        requestOptions?: ContextsClient.RequestOptions,
    ): core.HttpResponsePromise<Corti.AgenticContextsDetailResponse> {
    ...
    private async __get(
        ...
        request: Corti.agentic.AgenticContextsGetRequest = {},
        requestOptions?: ContextsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Corti.AgenticContextsDetailResponse>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)).base,
                `agentic/contexts/${core.url.encodePathParam(serializers.CommonContextIdValue.jsonOrThrow(contextId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        if (_response.ok) {
            return {
                data: serializers.AgenticContextsDetailResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/agentic/contexts/{contextId}");
    }
            ...
            async (
                ...
                const _response = await core.fetcher({
                    url: core.url.join(
                        (await core.Supplier.get(this._options.baseUrl)) ??
                            (await core.Supplier.get(this._options.environment)).base,
                        `agentic/contexts/${core.url.encodePathParam(serializers.CommonContextIdValue.jsonOrThrow(contextId, { omitUndefined: true }))}/trace`,
                    ),
                    method: "GET",
                    headers: _headers,
                    queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
                ...
                if (_response.ok) {
                    return {
                        data: serializers.AgenticContextsTraceResponse.parseOrThrow(_response.body, {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
                            allowUnrecognizedEnumValues: true,
                            skipValidation: true,
                ...
                return handleNonStatusCodeError(
                    ...
                    _response.rawResponse,
                    "GET",
                    "/agentic/contexts/{contextId}/trace",
                );
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Corti.AgenticContextsTraceItem, Corti.AgenticContextsTraceResponse>({
            response: dataWithRawResponse.data,
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.nextPageToken != null &&
