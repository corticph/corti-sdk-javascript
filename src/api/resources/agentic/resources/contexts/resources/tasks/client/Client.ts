...
export class TasksClient {
     ...
     * @param {Corti.agentic.contexts.ListTasksRequest} request
    ...
    public list(
        ...
        request: Corti.agentic.contexts.ListTasksRequest = {},
        requestOptions?: TasksClient.RequestOptions,
    ): core.HttpResponsePromise<Corti.CommonTaskListResponse> {
        return core.HttpResponsePromise.fromPromise(this.__list(contextId, request, requestOptions));
    }
