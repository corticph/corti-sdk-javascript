...
export interface AgentsAgentCard {
    ...
    additionalInterfaces?: Corti.agents.AgentsAgentInterface[] | null;
    /** A URL to an icon representing the agent. */
    iconUrl?: string | null;
    /** A URL to documentation describing how to interact with the agent. */
    documentationUrl?: string | null;
    provider?: Corti.agents.AgentsAgentProvider;
    /** The version of the agent. */
    version: string;
    capabilities: Corti.agents.AgentsAgentCapabilities;
    ...
    skills: Corti.agents.AgentsAgentSkill[];
    ...
    signatures?: Corti.agents.AgentsAgentCardSignature[] | null;
}
