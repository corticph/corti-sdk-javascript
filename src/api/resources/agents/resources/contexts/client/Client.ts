...
export class ContextsClient {
     ...
     * @param {Corti.agents.GetContextsRequest} request
     ...
     *
     * @example
     *     await client.agents.contexts.get("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51")
     */
    public get(
        contextId: Corti.CommonContextIdValue,
        request: Corti.agents.GetContextsRequest = {},
     ...
     *
     * @example
     *     await client.agents.contexts.delete("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51")
     */
    public delete(
        contextId: Corti.CommonContextIdValue,
        requestOptions?: ContextsClient.RequestOptions,
     ...
     *
     * @param {Corti.CommonContextIdValue} contextId - Context identifier (prefixed UUIDv7).
     * @param {Corti.agents.GetTraceContextsRequest} request
     * @param {ContextsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @example
     *     await client.agents.contexts.getTrace("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51")
     */
    public async getTrace(
        contextId: Corti.CommonContextIdValue,
        request: Corti.agents.GetTraceContextsRequest = {},
        requestOptions?: ContextsClient.RequestOptions,
