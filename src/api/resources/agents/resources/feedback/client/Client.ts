...
export class FeedbackClient {
     ...
     *
     * @example
     *     await client.agents.feedback.list("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51", "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62")
     */
    public list(
     ...
     * @param {Corti.CommonContextIdValue} contextId - Context identifier (prefixed UUIDv7).
     * @param {Corti.CommonTaskIdValue} taskId - Task identifier (prefixed UUIDv7).
     * @param {Corti.agents.FeedbackCreateRequest} request
     * @param {FeedbackClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     *
     * @example
     *     await client.agents.feedback.create("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51", "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62", {
     *         rating: {
     *             scale: "binary",
     *             value: 1
     *         }
    ...
    public create(
        contextId: Corti.CommonContextIdValue,
        taskId: Corti.CommonTaskIdValue,
        request: Corti.agents.FeedbackCreateRequest,
        requestOptions?: FeedbackClient.RequestOptions,
    ...
    private async __create(
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.agents.FeedbackCreateRequest.jsonOrThrow(request, {
     ...
     *
     * @example
     *     await client.agents.feedback.delete("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51", "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62")
     */
    public delete(
        contextId: Corti.CommonContextIdValue,
        taskId: Corti.CommonTaskIdValue,
