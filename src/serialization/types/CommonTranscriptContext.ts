...
export const CommonTranscriptContext: core.serialization.ObjectSchema<
    serializers.CommonTranscriptContext.Raw,
    Corti.CommonTranscriptContext
> = core.serialization.object({
    type: core.serialization.stringLiteral("transcript"),
    transcript: GuidedDocumentTranscriptMinimal,
});

export declare namespace CommonTranscriptContext {
