...
export const AgentsAgentCard: core.serialization.ObjectSchema<
    serializers.agents.AgentsAgentCard.Raw,
    Corti.agents.AgentsAgentCard
...
export declare namespace AgentsAgentCard {
    export interface Raw {
        ...
        description: string;
        url: string;
        preferredTransport?: (string | null | undefined) | null;
        ...
        supportsAuthenticatedExtendedCard?: (boolean | null | undefined) | null;
