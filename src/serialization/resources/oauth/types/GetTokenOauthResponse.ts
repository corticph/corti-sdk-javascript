...
export const GetTokenOauthResponse: core.serialization.ObjectSchema<
    serializers.GetTokenOauthResponse.Raw,
    Corti.GetTokenOauthResponse
...
export declare namespace GetTokenOauthResponse {
