...
export class CortiClient {
            ...
            headers: mergeHeaders(
                {
                    ...
                    "X-Fern-SDK-Version": "0.3.0-agents",
                    "User-Agent": "@corti/sdk/0.3.0-agents",
     ...
     *
     * @example
     *     await client.postAgentsIdV1MessageStream("id")
     */
    public postAgentsIdV1MessageStream(
        id: string,
        requestOptions?: CortiClient.RequestOptions,
    ): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__postAgentsIdV1MessageStream(id, requestOptions));
    }

    private async __postAgentsIdV1MessageStream(
        id: string,
        requestOptions?: CortiClient.RequestOptions,
