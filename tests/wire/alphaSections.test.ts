...
describe("AlphaSectionsClient", () => {
    test("list", async () => {
        ...
        server.mockEndpoint().get("/alpha/sections/").respondWith().statusCode(200).build();
    ...
    test("create", async () => {
        ...
        server.mockEndpoint().post("/alpha/sections/").respondWith().statusCode(200).build();
    ...
    test("get", async () => {
        ...
        server.mockEndpoint().get("/alpha/sections/sectionID").respondWith().statusCode(200).build();
    ...
    test("update", async () => {
        ...
        server.mockEndpoint().patch("/alpha/sections/sectionID").respondWith().statusCode(200).build();
