...
describe("TasksClient", () => {
    test("list (1)", async () => {
        ...
        const page = await client.agents.contexts.tasks.list("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51");
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.agents.contexts.tasks.list("contextId");
    ...
    test("get (1)", async () => {
        ...
        const response = await client.agents.contexts.tasks.get(
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.agents.contexts.tasks.get("contextId", "taskId");
        }).rejects.toThrow(Corti.UnauthorizedError);
    });
