...
describe("ContextsClient", () => {
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.agents.contexts.get("contextId");
    ...
    test("delete (1)", async () => {
        ...
        const response = await client.agents.contexts.delete("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51");
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.agents.contexts.delete("contextId");
        }).rejects.toThrow(Corti.UnauthorizedError);
    });
    ...
    test("getTrace (1)", async () => {
        ...
        const page = await client.agents.contexts.getTrace("ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51");
    ...
    test("getTrace (2)", async () => {
        ...
        await expect(async () => {
            return await client.agents.contexts.getTrace("contextId");
