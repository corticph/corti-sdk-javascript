...
describe("A2AClient", () => {
    test("jsonRpc (1)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/v2/agentic/agents/agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40/a2a")
    ...
    test("jsonRpc (2)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/v2/agentic/agents/agentId/a2a")
            .header("A2A-Version", "1.0")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(401)
        ...
        await expect(async () => {
            return await client.agentic.a2A.jsonRpc("agentId", {
                id: "id",
                method: "SendMessage",
            });
    ...
    test("sendMessage (1)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/v2/agentic/agents/agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40/a2a/message:send")
            .header("A2A-Version", "1.0")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
    ...
    test("sendMessage (2)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/v2/agentic/agents/agentId/a2a/message:send")
            .header("A2A-Version", "1.0")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(400)
        ...
        await expect(async () => {
            return await client.agentic.a2A.sendMessage("agentId", {
                message: {
                    role: "ROLE_USER",
                    parts: [{}, {}],
                },
    ...
    test("streamMessage (1)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/v2/agentic/agents/agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40/a2a/message:stream")
            .header("A2A-Version", "1.0")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
    ...
    test("streamMessage (2)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/v2/agentic/agents/agentId/a2a/message:stream")
            .header("A2A-Version", "1.0")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(400)
        ...
        await expect(async () => {
            return await client.agentic.a2A.streamMessage("agentId", {
                message: {
                    role: "ROLE_USER",
                    parts: [{}, {}],
                },
