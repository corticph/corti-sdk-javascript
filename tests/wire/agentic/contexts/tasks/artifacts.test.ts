...
describe("ArtifactsClient", () => {
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get(
                "/agentic/contexts/ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51/tasks/task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62/artifacts/art.0192f4c8-6a9e-7f72-a35e-70c1ac6fbe84",
            )
            .respondWith()
            .statusCode(200)
        ...
        const response = await client.agentic.contexts.tasks.artifacts.get(
    ...
    test("get (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/agentic/contexts/contextId/tasks/taskId/artifacts/artifactId")
            .respondWith()
            .statusCode(401)
            .jsonBody(rawResponseBody)
            .build();
        ...
        await expect(async () => {
            return await client.agentic.contexts.tasks.artifacts.get("contextId", "taskId", "artifactId");
