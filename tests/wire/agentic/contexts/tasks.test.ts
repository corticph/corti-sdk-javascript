...
describe("TasksClient", () => {
    test("list (1)", async () => {
        ...
        server
            ...
            .get("/agentic/contexts/ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51/tasks")
            .respondWith()
            .statusCode(200)
    ...
    test("list (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/agentic/contexts/contextId/tasks")
            .respondWith()
            .statusCode(401)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get(
                "/agentic/contexts/ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51/tasks/task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62",
            )
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
    ...
    test("get (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/agentic/contexts/contextId/tasks/taskId")
            .respondWith()
            .statusCode(401)
            .jsonBody(rawResponseBody)
            .build();
