...
describe("TasksClient", () => {
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.agentic.a2A.tasks.list("agentId");
    ...
    test("get (1)", async () => {
        ...
        const response = await client.agentic.a2A.tasks.get(
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.agentic.a2A.tasks.get("agentId", "taskId");
        }).rejects.toThrow(Corti.UnauthorizedError);
    });
    ...
    test("cancel (1)", async () => {
        ...
        const response = await client.agentic.a2A.tasks.cancel(
            "agt.0192f4c8-2c5a-7b3e-9f1a-3c8d6e2b7a40",
            "task.0192f4c8-4e7c-7d50-b13c-5eaf8a4d9c62",
        );
        expect(response).toEqual({
    ...
    test("cancel (2)", async () => {
        ...
        await expect(async () => {
            return await client.agentic.a2A.tasks.cancel("agentId", "taskId");
        }).rejects.toThrow(Corti.UnauthorizedError);
    });
