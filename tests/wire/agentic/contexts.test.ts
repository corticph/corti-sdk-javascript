...
describe("ContextsClient", () => {
    ...
    test("list (2)", async () => {
        ...
        server.mockEndpoint().get("/agentic/contexts").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/agentic/contexts/ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/agentic/contexts/contextId")
            .respondWith()
            .statusCode(401)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("delete (1)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/agentic/contexts/ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51")
            .respondWith()
            .statusCode(200)
            .build();
    ...
    test("delete (2)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/agentic/contexts/contextId")
            .respondWith()
            .statusCode(401)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("trace (1)", async () => {
        ...
        server
            .mockEndpoint({ once: false })
            .get("/agentic/contexts/ctx.0192f4c8-3d6b-7c4f-a02b-4d9e7f3c8b51/trace")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("trace (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/agentic/contexts/contextId/trace")
            .respondWith()
            .statusCode(400)
            .jsonBody(rawResponseBody)
            .build();
