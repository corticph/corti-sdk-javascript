...
describe("NewTemplateVersionsClient", () => {
    test("list", async () => {
        ...
        server.mockEndpoint().get("/new/templates/templateId/versions").respondWith().statusCode(200).build();
    ...
    test("create", async () => {
        ...
        server.mockEndpoint().post("/new/templates/templateId/versions").respondWith().statusCode(200).build();
    ...
    test("get", async () => {
        ...
        server.mockEndpoint().get("/new/templates/templateId/versions/versionID").respondWith().statusCode(200).build();
