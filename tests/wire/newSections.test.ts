...
describe("NewSectionsClient", () => {
    ...
    test("get", async () => {
        ...
        server.mockEndpoint().get("/new/sections/sectionID").respondWith().statusCode(200).build();
    ...
    test("update", async () => {
        ...
        server.mockEndpoint().patch("/new/sections/sectionID").respondWith().statusCode(200).build();
