...
describe("cortiClient.agents.create", () => {
    ...
    describe("should create agent with only required values", () => {
        it.concurrent("should create agent with only name and description without errors or warnings", async () => {
            expect.assertions(2);
    ...
    describe("should create agent with all optional values", () => {
        it.concurrent("should create agent with systemPrompt without errors or warnings", async () => {
            expect.assertions(2);
        ...
        it.concurrent("should create agent with ephemeral set to true without errors or warnings", async () => {
            expect.assertions(2);
        ...
        it.concurrent("should create agent with all optional parameters without errors or warnings", async () => {
            expect.assertions(2);
