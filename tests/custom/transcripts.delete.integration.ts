...
describe('cortiClient.transcripts.delete', () => {
  ...
  describe('should throw error when invalid parameters are provided', () => {
    it('should throw error when interaction ID is invalid format', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete('invalid-uuid', faker.string.uuid())
    ...
    it('should throw error when transcript ID is invalid format', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete(interactionId, 'invalid-uuid')
      ).rejects.toThrow('Status code: 400');
    });
    ...
    it('should throw error when interaction ID does not exist', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete(faker.string.uuid(), faker.string.uuid())
    ...
    it('should throw error when interaction ID is null', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete(null as any, faker.string.uuid())
    ...
    it('should throw error when transcript ID is null', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete(interactionId, null as any)
      ).rejects.toThrow('Expected string. Received null.');
    });
    ...
    it('should throw error when interaction ID is undefined', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete(undefined as any, faker.string.uuid())
    ...
    it('should throw error when transcript ID is undefined', async () => {
      ...
      await expect(
        cortiClient.transcripts.delete(interactionId, undefined as any)
      ).rejects.toThrow('Expected string. Received undefined.');
    });
    ...
    it('should throw error when transcript ID does not exist', async () => {
        ...
        await expect(
            cortiClient.transcripts.delete(interactionId, faker.string.uuid())
        ).rejects.toThrow('Status code: 404');
      });
  });
}); 