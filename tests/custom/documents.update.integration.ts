...
describe("cortiClient.documents.update", () => {
    ...
    describe("should update document with minimal fields", () => {
        it.concurrent("should update document with empty request (no changes) without errors or warnings", async () => {
            expect.assertions(2);
        ...
        it.concurrent("should update document with only name without errors or warnings", async () => {
            expect.assertions(4);
        ...
        it.concurrent("should update document with only sections without errors or warnings", async () => {
            expect.assertions(4);
    ...
    describe("should update document with section variations", () => {
        it.concurrent(
            "should update document with section containing all optional fields without errors or warnings",
            async () => {
                expect.assertions(7);
        ...
        it.concurrent("should update document with empty sections array without errors or warnings", async () => {
            expect.assertions(2);
    ...
    it.concurrent(
        "should update document with all possible optional parameters without errors or warnings",
        async () => {
            expect.assertions(8);
    ...
    describe("should throw error when invalid parameters are provided", () => {
        ...
        it.concurrent("should throw error when document ID is invalid", async () => {
            expect.assertions(1);
        ...
        it.concurrent("should throw error when section key is missing", async () => {
            expect.assertions(1);
