...
describe("cortiClient.interactions.list", () => {
    ...
    it.concurrent("should return empty result when no interactions exist", async () => {
        expect.assertions(3);
    ...
    it.concurrent("should return interactions when they exist", async () => {
        expect.assertions(4);
    ...
    describe("filtering by patient", () => {
        it.concurrent("should return only interactions for specified patient", async () => {
            expect.assertions(5);
        ...
        it.concurrent("should return empty result for non-existent patient", async () => {
            expect.assertions(3);
    ...
    describe("filtering by encounterStatus", () => {
        it.concurrent("should filter by single encounterStatus string", async () => {
            expect.assertions(4);
        ...
        describe("should find interactions for all valid status enum values", () => {
            it.concurrent("should find planned interactions", async () => {
                expect.assertions(3);
            ...
            it.concurrent("should find in-progress interactions", async () => {
                expect.assertions(3);
            ...
            it.concurrent("should find on-hold interactions", async () => {
                expect.assertions(3);
            ...
            it.concurrent("should find completed interactions", async () => {
                expect.assertions(3);
            ...
            it.concurrent("should find cancelled interactions", async () => {
                expect.assertions(3);
            ...
            it.concurrent("should find deleted interactions", async () => {
                expect.assertions(3);
    ...
    describe("error handling", () => {
        it.concurrent("should throw error for invalid encounterStatus", async () => {
            expect.assertions(1);
    ...
    describe("sorting", () => {
        it.concurrent("should sort by default (createdAt desc) when no sort parameters provided", async () => {
            expect.assertions(3);
        ...
        describe("sort by createdAt", () => {
            it.concurrent("should sort by createdAt desc", async () => {
                expect.assertions(4);
            ...
            it.concurrent("should sort by createdAt asc", async () => {
                expect.assertions(4);
            ...
            it.concurrent(
                "should sort by createdAt with default direction (desc) when direction not specified",
                async () => {
                    expect.assertions(3);
        ...
        describe("sort by updatedAt", () => {
            it.concurrent("should sort by updatedAt desc", async () => {
                expect.assertions(4);
            ...
            it.concurrent("should sort by updatedAt asc", async () => {
                expect.assertions(4);
        ...
        describe("sort by id", () => {
            it.concurrent("should sort by id desc", async () => {
                expect.assertions(4);
            ...
            it.concurrent("should sort by id asc", async () => {
                expect.assertions(4);
        ...
        describe("sort by assignedUserId", () => {
            it.concurrent("should sort by assignedUserId desc", async () => {
                expect.assertions(4);
            ...
            it.concurrent("should sort by assignedUserId asc", async () => {
                expect.assertions(4);
        ...
        describe.skip("sort by patient", () => {
            it.concurrent("should sort by patient desc", async () => {
                expect.assertions(4);
            ...
            it.concurrent("should sort by patient asc", async () => {
                expect.assertions(4);
    ...
    describe("pagination", () => {
        it.concurrent("should iterate through all interactions using async iterator", async () => {
            expect.assertions(4);
        ...
        it.concurrent("should iterate through pages manually using hasNextPage and getNextPage", async () => {
            expect.assertions(4);
        ...
        it.concurrent("should use default pageSize when not specified", async () => {
            expect.assertions(2);
