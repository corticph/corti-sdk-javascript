...
describe("cortiClient.recordings.get", () => {
    ...
    describe("should handle get errors", () => {
        ...
        it("should throw error when interaction ID is null", async () => {
            ...
            await expect(cortiClient.recordings.get(null as any, faker.string.uuid())).rejects.toThrow(
        ...
        it("should throw error when recording ID is null", async () => {
            ...
            await expect(cortiClient.recordings.get(interactionId, null as any)).rejects.toThrow(
                "Expected string. Received null.",
            );
        });
        ...
        it("should throw error when interaction ID is undefined", async () => {
            ...
            await expect(cortiClient.recordings.get(undefined as any, faker.string.uuid())).rejects.toThrow(
