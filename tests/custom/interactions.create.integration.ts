...
import { createTestCortiClient, cleanupInteractions, setupConsoleWarnSpy } from "./testUtils";
...
describe("cortiClient.interactions.create", () => {
    ...
    describe("should throw error when required fields are missing", () => {
        it("should throw error when encounter is missing", async () => {
            ...
            await expect(cortiClient.interactions.create({} as any)).rejects.toThrow(
                'Missing required key "encounter"',
            );
        });
